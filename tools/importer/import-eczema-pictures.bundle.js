...
var CustomImportScript = (() => {
  ...
  // tools/importer/import-eczema-pictures.js
  var import_eczema_pictures_exports = {};
  __export(import_eczema_pictures_exports, {
    default: () => import_eczema_pictures_default
  });
  ...
  var import_eczema_pictures_default = {
    transform: (payload) => {
      ...
      return [{ element: main, path, report: { title: document.title, template: "eczema-pictures" } }];
    }
  };
  return __toCommonJS(import_eczema_pictures_exports);
})();
